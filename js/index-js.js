...
candleBtn.onclick = function () {
    ...
    if (on == true) {
        ...
        candleInfos.forEach(function (element) {
            element.style.backgroundColor = nMAinColor;
        });
        ...
        serviceItem.forEach(function (element) {
            element.style.backgroundColor = nLightColor;
        });
        servCircle.forEach(function (element) {
            element.style.backgroundColor = nMAinColor;
        });
        servTitle.forEach(function (element) {
            element.style.color = dLightColor;
        });
    ...
    // وقتی میخوایم روشن کنیم
        ...
        candleInfos.forEach(function (element) {
            element.style.backgroundColor = dMainColor;
        });
        ...
        serviceItem.forEach(function (element) {
            element.style.backgroundColor = dLightColor;
        });
        servCircle.forEach(function (element) {
            element.style.backgroundColor = dMainColor;
        });
        servTitle.forEach(function (element) {
            element.style.color = dMainColor;
        });
